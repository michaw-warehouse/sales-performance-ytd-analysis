...
Country-level performance analysis (USA, Canada, Mexico)
...
Highlights performance gaps using YTD variance.

Enables comparison between current performance and previous periods.
